...
export default function Sidebar_com() {
  ...
  return (
    <div className="w-2/12 py-4 relative h-full text-gray-900 ">
      <div className="flex items-center justify-center py-2 border-b border-b-gray-400">
        <h1 className="text-xl p-2 flex items-center justify-center">
      ...
      <div className="flex items-center justify-center flex-col  my-2">
        <ul className="w-full h-full ">
          ...
          <li
            ...
            className="text-lg hover:bg-orange-600 hover:text-white p-2 my-2 border-b border-b-gray-400 transition duration-500 font-semibold flex items-center justify-start mx-4  cursor-pointer "
          >
            <IoMdAddCircle className="mr-2" /> Add Product
          </li>
          <li
            onClick={() => Router.push("/admin/products/getProducts")}
            className="text-lg hover:bg-orange-600 hover:text-white p-2 my-2 border-b border-b-gray-400 transition duration-500 font-semibold flex items-center justify-start mx-4  cursor-pointer "
          >
            <BiCategory className="mr-2" /> View Products
          </li>
          <li
            onClick={() => Router.push("/admin/categories/addCategory")}
            className="text-lg hover:bg-orange-600 hover:text-white p-2 my-2 border-b border-b-gray-400 transition duration-500 font-semibold flex items-center justify-start mx-4  cursor-pointer "
          >
            <IoMdAddCircle className="mr-2" /> Add Category
          </li>
          <li
            onClick={() => Router.push("/admin/categories/categories")}
            className="text-lg hover:bg-orange-600 hover:text-white p-2 my-2 border-b border-b-gray-400 transition duration-500 font-semibold flex items-center justify-start mx-4  cursor-pointer "
          >
            <BiCategory className="mr-2" /> View Categories
          </li>
          <li
            onClick={() => Router.push("/admin/history/historyOrders")}
            className="text-lg hover:bg-orange-600 hover:text-white p-2 my-2 border-b border-b-gray-400 transition duration-500 font-semibold flex items-center justify-start mx-4  cursor-pointer "
          >
            <BiCategory className="mr-2" /> View Histories
          </li>
          <li
            onClick={() => Router.push("/admin/users/getUsers")}
            className="text-lg hover:bg-orange-600 hover:text-white p-2 my-2 border-b border-b-gray-400 transition duration-500 font-semibold flex items-center justify-start mx-4  cursor-pointer "
          >
            <BiCategory className="mr-2" /> View Users
          </li>
          <li
            onClick={() => Router.push("/admin/chat")}
            className="text-lg hover:bg-orange-600 hover:text-white p-2 my-2 border-b border-b-gray-400 transition duration-500 font-semibold flex items-center justify-start mx-4  cursor-pointer "
          >
            <BiCategory className="mr-2" /> Chat
          </li>
        </ul>
      </div>
      <div className="w-full absolute bottom-10 left-0 ">
        <button
          onClick={logout}
          className="text-lg p-2 w-full h-full hover:bg-orange-600 hover:text-white   transition duration-500 font-semibold flex items-center justify-center  cursor-pointer "
        >
